                ...
                <div class="col-xs-12 col-sm-4 col-sm-offset-8" id="bgright"></div>
                    ...
                    <div class="col-xs-12 col-sm-4" id="right">
                        ...
                        <h1>Sign-In</h1>
                          ...
                          <button type="submit" class="btn btn-default" onclick="location.href='home.php'">Sign-in</button>
                        </form>
                        <div class="row col-xs-12" id="signup">
                            <h3>Need an account?<br><a href="http://slateproject.me/application/views/registration.php">Sign Up</a></h3>
                        </div>
